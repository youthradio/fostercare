...
function showAll(){
 ...
 document.getElementById("testing").innerHTML = "<audio controls> <source src='Non-Relative Foster Family_Foster Youth Voices_Being In Foster Care Made Me Stronger_Melissa Beavers.mp3' tyle='audio/mpeg'>";
  ...
  document.getElementById('head2').style.visibility='visible';
  document.getElementById("storyTitle").innerHTML='“Being In Foster Care Made Me Stronger”';
  document.getElementById("storyDesc").innerHTML='Youth Radio reporter and former foster youth Noel Anaya, now 21, spent a year in a group home when he was 12 years old. He says from the moment he got there, he felt like it was a mistake.';
   ...
   function mInfo3(){
    ...
    document.getElementById('head2').style.visibility='visible';
    document.getElementById("storyTitle").innerHTML='“When Home Feels Like A Prison”';
    document.getElementById("storyDesc").innerHTML='Youth Radio reporter and former foster youth Noel Anaya, now 21, spent a year in a group home when he was 12 years old. He says from the moment he got there, he felt like it was a mistake.';
...
function mInfo5(){
  ...
  document.getElementById('head2').style.visibility='visible';
    ...
    function appearR(){
      ...
      document.getElementById("videEm").innerHTML="This is some text to intro Noel and this video <br> <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://www.youtube.com/embed/RfEiQqSIOsw' frameborder='0' allowfullscreen></iframe></div>";
    }
