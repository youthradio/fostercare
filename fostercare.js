...
function showAll(){
 ...
 function mInfo1(){
   ...
   function mInfo3(){
   	showAll();
    document.getElementById("testing").innerHTML = "<strong>When Home Feels Like a Prison</strong> <br> <img src='noel_hub.jpg' class='img-fluid'> <br>   <br> <audio controls> <source src='Group Home_Foster Youth Voices_When Home Feels Like A Prison_Noel Anaya.mp3' tyle='audio/mpeg'> </audio> <br> <br> Youth Radio reporter and former foster youth Noel Anaya, now 21, spent a year in a group home when he was 12 years old. He says from the moment he got there, he felt like it was a mistake.";
